...
class EventsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.events.index', compact('records'));
    }
    ...
    public function store(EventStoreRequest $request)
    {
        ...
        return redirect()
            ...
            ->with('success', 'events has been added successfully.');
    }
    ...
    public function update(EventUpdateRequest $request, $id)
    {
        ...
        return redirect()
            ->route('admin.events.index')
            ->with('success', 'events updated sucessfully.');
    }
    ...
    {
        $service = Event::findOrFail($id); // delete user
        ...
        return redirect()
            ->route('admin.events.index')
            ->with('success', 'events was removed successfully!');
    }
}
