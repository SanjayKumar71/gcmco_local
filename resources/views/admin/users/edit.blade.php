            ...
            <div class="portlet-body">
                ...
                <form method="POST" action="{{ route('admin.users.update', $data->id) }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" readonly name="email" value="{{ old('email', $data->email) }}" class="form-control" required />
                        </div>
                        <label for="contact_number" class="col-md-2 control-label">Phone *</label>
                        <div class="col-md-4">
                            <input type="text" name="contact_number" value="{{ old('contact_number', $data->contact_number) }}" class="form-control" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="status" required>
                                ...
                                <option value="0" {{ old('status', $data->status) == '0' ? 'selected="selected"' : '' }}>Inactive</option>
                            </select>
                        </div>
                    </div>
