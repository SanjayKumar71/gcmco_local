...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.work_with_me.index') }}
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('admin.work_with_me.update', $records->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="title" maxlength="190"
                                       value="{{ old('title', $records->title) }}" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sub_title" class="col-md-2 control-label">Sub title *</label>
                            <div class="col-md-4">
                                <input type="text" name="sub_title" maxlength="190"
                                       value="{{ old('sub_title', $records->sub_title) }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="title_one" class="col-md-2 control-label">title</label>
                            <div class="col-md-4">
                                <input type="text" name="title_one" maxlength="190"
                                       value="{{ old('title_one', $records->title_one) }}" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description_one" class="col-md-2 control-label">description One</label>
                            <div class="col-md-4">
                                <input type="text" name="description_one" maxlength="190"
                                       value="{{ old('description_one', $records->description_one) }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="title_two" class="col-md-2 control-label">title two</label>
                            <div class="col-md-4">
                                <input type="text" name="title_two" maxlength="190"
                                       value="{{ old('title_two', $records->title_two) }}" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description_two" class="col-md-2 control-label">description two</label>
                            <div class="col-md-4">
                                <input type="text" name="description_two" maxlength="190"
                                       value="{{ old('description_two', $records->description_two) }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="title_three" class="col-md-2 control-label">title three</label>
                            <div class="col-md-4">
                                <input type="text" name="title_three" maxlength="190"
                                       value="{{ old('title_three', $records->title_three) }}" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description_three" class="col-md-2 control-label">description three</label>
                            <div class="col-md-4">
                                <input type="text" name="description_three" maxlength="190"
                                       value="{{ old('description_three', $records->description_three) }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
