            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body">
                        ...
                        <form method="POST" action="{{ route('admin.history.update', $records->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @endif
                                    <br/>
                                    <input type="file" name="banner_image" value="{{ old('banner_image', $records->banner_image) }}" class="form-control" multiple/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="heading" maxlength="190" value="{{ old('heading', $records->heading) }}" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
