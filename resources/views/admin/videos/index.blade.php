                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-toolbar pull-right">
                            <div class="btn-group">
                                <a href="{!! URL::route('admin.videos.create') !!}" id="sample_editable_1_new"
                                class="btn btn-info">
                                    ...
                                    <tr class="odd gradeX">
                                        <td>
                                            <video width="220" height="140" controls>
                                                <source src="{{URL::asset(uploadsDir().$record->video ?? '')}}" type="video/mp4">
                                        ...
                                        <td class="center text-center" width="18%">
                                            <a href="{!! URL::route('admin.videos.show', $record->id) !!}" class="btn btn-xs blue"
                                            title="Show Record">
                                                <i class="fa fa-search"></i>
                                            </a>
                                            <a class="btn btn-xs green"
                                            href="{!! URL::route('admin.videos.edit', $record->id) !!}" title="Edit">
                                            ...
                                            <!-- <form action="{!! URL::route('admin.videos.destroy', $record->id) !!}" method="POST"
