...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('admin.program_type.create') }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <h4>&nbsp;</h4>
                    <form method="POST" action="{{ route('admin.program_type.store') }}" class="form-horizontal" role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="name" id="name" maxlength="190" value="{{ old('name') }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="slug" id="slug" maxlength="190" value="{{ old('slug') }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
