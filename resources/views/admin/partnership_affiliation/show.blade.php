...
<div class="row">
    <div class="col-md-12">
        ...
        {{ Breadcrumbs::render('admin.partnership_affiliation.show', $data) }}
                ...
                <div class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <button class="btn black" id="cancel" onclick='window.location.href = "{!! URL::route('admin.partnership_affiliation.index') !!}"'> < Back..</button>
                        </div>
                    </div>
                </div>
