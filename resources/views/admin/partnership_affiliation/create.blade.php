...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('admin.partnership_affiliation.create') }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <h4>&nbsp;</h4>
                    <form method="POST" action="{{ route('admin.partnership_affiliation.store') }}" class="form-horizontal" role="form"
