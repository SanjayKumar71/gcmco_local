...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('admin.partnership_affiliation.edit', $data) }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('admin.partnership_affiliation.update', $data->id) }}" class="form-horizontal"
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $('#cancel').click(function () {
                window.location.href = "{!! URL::route('admin.partnership_affiliation.index') !!}";
            });
        });
