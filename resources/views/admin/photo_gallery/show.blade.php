                    ...
                    <div class="card-body">
                        ...
                        <div class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <label class="control-label"><img height="150" width="200" src="{!! asset(uploadsDir().$records->image) !!}"></label>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">
                                    <button class="btn black" id="cancel" onclick='window.location.href = "{!! URL::route('admin.photo_gallery.index') !!}"'> < Back..</button>
                                </div>
                            </div>
                        </div>
