                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center text-center">
                                        ...
                                        @if(in_array($record->id, $restrictedPages))
                                            <a class="btn btn-xs red" disabled href="javascript:;" data-title="Delete Record" title="Delete Record">
                                        ...
                                        @endif
                                        <form action="{!! URL::route('admin.pages.destroy', $record->id) !!}" method="POST" id="deleteForm{!! $record->id !!}">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                </td>
