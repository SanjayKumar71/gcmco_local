...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('admin.programs.index') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.programs.create') !!}" id="sample_editable_1_new"
                               class="btn blue">
        ...
        <!-- BEGIN EXAMPLE TABLE PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="programs_table">
                        <thead>
                        <tr>
                            <th>Title</th>
                            <th>SubTitle</th>
                        ...
                        @foreach ($records as $key => $record)
                            <tr class="odd gradeX">
                                ...
                                <td class="center text-center" width="10%">
                                    <a href="{!! URL::route('admin.programs.show', $record->id) !!}" class="btn btn-xs blue"
                                       title="Show Record">
                                        <i class="fa fa-search"></i>
                                    </a>
                                    <a class="btn btn-xs green"
                                       href="{!! URL::route('admin.programs.edit', $record->id) !!}" title="Edit">
                                    ...
                                    <form action="{!! URL::route('admin.programs.destroy', $record->id) !!}" method="POST"
...
@section('footer-js')
    ...
    <script>
        ...
        jQuery('#programs_table_wrapper .dataTables_filter input').addClass("form-control input-medium input-inline"); // modify table search input
        jQuery('#programs_table_wrapper .dataTables_length select').addClass("form-control input-xsmall"); // modify table per page dropdown
