        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <h4>&nbsp;</h4>
                    <form method="POST" action="{{ route('admin.programs.store') }}" class="form-horizontal" role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="sub_title" id="sub_title" maxlength="190" value="{{ old('sub_title') }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="third_sub_title" id="third_sub_title" maxlength="190" value="{{ old('third_sub_title') }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="price" id="price" maxlength="100" value="{{ old('price') }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="off_in_percent" id="off_in_percent" maxlength="3" value="{{ old('off_in_percent') }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea name="description" id="description" cols="100" rows="10" class="form-control ckeditor">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="about_traning" class="col-md-2 control-label">About Training *</label>
                            <div class="col-md-8">
                                <textarea name="about_traning" id="about_traning" cols="100" rows="10" class="form-control ckeditor">{{ old('about_traning') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="schedule_heading" class="col-md-2 control-label">Schedule Heading *</label>
                            <div class="col-md-8">
                                <input type="text" name="schedule_heading" id="schedule_heading" value="{{ old('schedule_heading') }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="schedule_note" id="schedule_note" value="{{ old('schedule_note') }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea name="learning_objective" id="learning_objective" cols="100" rows="10" class="form-control ckeditor">{{ old('learning_objective') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="course_features" class="col-md-2 control-label">Course Features *</label>
                            <div class="col-md-8">
                                <textarea name="course_features" id="course_features" cols="100" rows="10" class="form-control ckeditor">{{ old('course_features') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="student_material_classroom" class="col-md-2 control-label">Student Material Class Room *</label>
                            <div class="col-md-8">
                                <textarea name="student_material_classroom" id="student_material_classroom" cols="100" rows="10" class="form-control ckeditor">{{ old('student_material_classroom') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="student_material_online" class="col-md-2 control-label">Student Material Online *</label>
                            <div class="col-md-8">
                                <textarea name="student_material_online" id="student_material_online" cols="100" rows="10" class="form-control ckeditor">{{ old('student_material_online') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="about_heartsaver" class="col-md-2 control-label">About HeartSaver *</label>
                            <div class="col-md-8">
                                <textarea name="about_heartsaver" id="about_heartsaver" cols="100" rows="10" class="form-control ckeditor">{{ old('about_heartsaver') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="program_image" class="col-md-2 control-label">Image *</label>
                            <div class="col-md-4">
