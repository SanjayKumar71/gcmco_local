        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-toolbar pull-right">
                            <div class="btn-group">
                                <a href="{!! URL::route('admin.gcm_team.create') !!}" id="sample_editable_1_new"
                                class="btn btn-info">
                ...
                <div class="card box blue">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered table-hover" id="gcm_team_table">
                            <thead>
                                <tr>
                                    <th>Image</th>
                                    <th>First Name</th>
                                ...
                                @foreach ($records as $key => $record)
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center text-center" width="18%">
                                            <a href="{!! URL::route('admin.gcm_team.show', $record->id) !!}" class="btn btn-xs blue"
                                            title="Show Record">
                                                <i class="fa fa-search"></i>
                                            </a>
                                            <a class="btn btn-xs green"
                                            href="{!! URL::route('admin.gcm_team.edit', $record->id) !!}" title="Edit">
                                            ...
                                            <!-- <form action="{!! URL::route('admin.gcm_team.destroy', $record->id) !!}" method="POST"
