        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('admin.testimonials.update', $data->id) }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="review" id="title" maxlength="190"
                                       value="{{ old('review', $data->review) }}"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
