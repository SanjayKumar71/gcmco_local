            ...
            <!-- BEGIN SAMPLE FORM card-->
                <div class="card box blue">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.speaking_events.update', $records->id) }}" class="form-horizontal"
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">
                                    ...
                                    <input type="button" class="btn black" onclick='window.location.href = "{!! URL::route('admin.speaking_events.index') !!}"' name="cancel" id="cancel" value="Cancel">
                                </div>
                            </div>
