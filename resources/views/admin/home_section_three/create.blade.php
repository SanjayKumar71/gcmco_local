...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('admin.home_section_three.create') }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <h4>&nbsp;</h4>
                    <form method="POST" action="{{ route('admin.home_section_three.store') }}" class="form-horizontal" role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="title" id="title" maxlength="190" value="{{ old('title') }}" class="form-control"/>
                            </div>
                        </div>
