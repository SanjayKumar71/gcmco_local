...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('admin.success_stories.edit', $data) }}
        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('admin.success_stories.update', $data->id) }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            <label for="title" class="col-md-2 control-label">Heading *</label>
                            <div class="col-md-8">
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $('#cancel').click(function () {
                window.location.href = "{!! URL::route('admin.success_stories.index') !!}";
            });
        });
