...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('admin.success_stories.index') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.success_stories.create') !!}" id="sample_editable_1_new"
                               class="btn blue">
                        ...
                        @foreach ($records as $key => $record)
                            <tr class="odd gradeX">
                                ...
                                <td class="center text-center" width="10%">
                                    <a href="{!! URL::route('admin.success_stories.show', $record->id) !!}" class="btn btn-xs blue"
                                       title="Show Record">
                                        <i class="fa fa-search"></i>
                                    </a>
                                    <a class="btn btn-xs green"
                                       href="{!! URL::route('admin.success_stories.edit', $record->id) !!}" title="Edit">
                                    ...
                                    <form action="{!! URL::route('admin.success_stories.destroy', $record->id) !!}" method="POST"
