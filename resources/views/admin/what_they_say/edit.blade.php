            ...
            <!-- BEGIN SAMPLE FORM card-->
                <div class="card box blue">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.what_they_say.update', $records->id) }}" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea name="comment" class="form-control" rows="8" required>{{ old('comment', $records->comment) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-10">
                                    ...
                                    <input type="button" class="btn black" onclick='window.location.href = "{!! URL::route('admin.what_they_say.index') !!}"' name="cancel" id="cancel" value="Cancel">
                                </div>
                            </div>
