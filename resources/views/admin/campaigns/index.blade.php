                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-toolbar pull-right">
                            <div class="btn-group">
                                <a href="{!! URL::route('admin.campaigns.create') !!}" id="sample_editable_1_new"
                                class="btn btn-info">
                                ...
                                @foreach ($records as $key => $record)
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center text-center" width="16%">
                                            ...
                                            href="{!! URL::route('admin.campaigns.edit', $record->id) !!}" title="Edit">
                                            ...
                                            <!-- <form action="{!! URL::route('admin.campaigns.destroy', $record->id) !!}" method="POST"
