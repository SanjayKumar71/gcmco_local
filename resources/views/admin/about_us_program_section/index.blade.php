...
@section('content')
    ...
    <div class="row">
        ...
        {{ Breadcrumbs::render('admin.about_us_program_section.index') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.about_us_program_section.create') !!}" id="sample_editable_1_new"
                               class="btn blue">
        ...
        <!-- BEGIN EXAMPLE TABLE PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="about_us_program_section_table">
                        <thead>
                        <tr>
                            <th>Icon</th>
                            <th>Heading</th>
                        ...
                        @foreach ($records as $key => $record)
                            <tr class="odd gradeX">
                                ...
                                <td class="center text-center" width="10%">
                                    <a href="{!! URL::route('admin.about_us_program_section.show', $record->id) !!}" class="btn btn-xs blue"
                                       title="Show Record">
                                        <i class="fa fa-search"></i>
                                    </a>
                                    <a class="btn btn-xs green"
                                       href="{!! URL::route('admin.about_us_program_section.edit', $record->id) !!}" title="Edit">
                                    ...
                                    <form action="{!! URL::route('admin.about_us_program_section.destroy', $record->id) !!}" method="POST"
...
@section('footer-js')
    ...
    <script>
        $('#about_us_program_section_table').dataTable({
            "aLengthMenu": [
                [5, 15, 20, -1],
        ...
        jQuery('#about_us_program_section_table_wrapper .dataTables_filter input').addClass("form-control input-medium input-inline"); // modify table search input
        jQuery('#about_us_program_section_table_wrapper .dataTables_length select').addClass("form-control input-xsmall"); // modify table per page dropdown
